...
document.write(myFavoriteFood);document.write("<br>");
...
for(var i=0;i<130;i+=3){document.write(i);document.write("<br>");}
//10. Create a for loop that counts from 3 to 17 by 2s
for(var i=3;i<17;i+=2){document.write(i);document.write("<br>");}
//11. Create a for loop that counts from 100 to 3 by -1
for(var i=100;i>3;i--){document.write(i);document.write("<br>");}
//12. Create a for loop that counts from 1 to 100 by 1s
for(var i=1;i<100;i++){document.write(i);document.write("<br>");}
